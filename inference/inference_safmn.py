...
from basicsr.archs.safm_arch import SAFMN
from collections import OrderedDict
from basicsr.utils import get_root_logger, get_time_str
from utility.model_summary import get_model_activation, get_model_flops
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='results/test_demo', help='Path to log file')
    ...
    parser.add_argument('--save_path', type=str, default='results/test_demo', help='Path to results')
    parser.add_argument('--pretrain_model', type=str, default='pretrain_models/safm/SAFMN_DF2K_x2.pth', help='Path to the pretrained model')
